...
import OptionsBtn from "../../Chat/OptionsButton";
		...
		<aside className="sidebar">
			<header className="header">
				...
				<div className="sidebar__actions">
					...
					<button className="sidebar__action" aria-label="New Group">
						<Icon id="group" className="sidebar__action-icon" />
					</button> */}
					
					{/* <Icon id="search" className="search-icon" /> */}
					<button className="sidebar__action">
						<Icon id="search" className="sidebar__action-icon" />
					</button>
